...
.navbar {
  overflow: hidden; /*extra content it now hidden*/
...
.navbar a {
  float: left; /*position element*/
  font-size: 16px;
  color: white;
  text-align: center;/*how text position going to be*/
  padding: 14px 16px;/*create space inside in braode */
